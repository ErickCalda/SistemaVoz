...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.code === 'auth/email-already-in-use') {
        ...
        setError('Ha ocurrido un error al registrarse. Por favor intenta nuevamente.');
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError('Ha ocurrido un error al registrarse con Google. Por favor intenta nuevamente.');
    } finally {
      setLoading(false);
    }
  };
